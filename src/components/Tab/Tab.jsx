  ...
  return (
    ...
    >
      <motion.div whileHover={{ scale: 1.1 }}>
        <HashLink
          to={"/home"}
          className=" transition  duration-200  py-1 px-2 hover:text-black/80  hover:bg-slate-200 rounded-md cursor-pointer text-slate-700/80 font-semibold "
        >
          Home
        </HashLink>
      </motion.div>
      <motion.div whileHover={{ scale: 1.1 }}>
        <Link
          to={"/expertise"}
          className=" transition  duration-200 py-1 px-1 hover:text-black/80  hover:bg-slate-200 rounded-md cursor-pointer text-slate-700/80 font-semibold "
        >
          Expertise
        </Link>
      </motion.div>
