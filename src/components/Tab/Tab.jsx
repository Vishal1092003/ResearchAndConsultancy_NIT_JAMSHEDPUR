    ...
    <>
      ...
      <motion.div whileHover={{ scale: 1.05 }}>
        <Link
            ...
            className={`transition duration-200 py-2 px-3 rounded-md cursor-pointer font-medium whitespace-nowrap ${isActive("/FundOpportunities") ? "bg-slate-200 text-black" : "text-slate-700/80 hover:text-black/80 hover:bg-slate-200"}`}
        >
          Fund Opportunities
        </Link>
      </motion.div>
