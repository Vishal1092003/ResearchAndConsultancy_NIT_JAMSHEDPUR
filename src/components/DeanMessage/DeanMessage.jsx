    ...
    >
      <div className="w-full flex p-4 min-h-[70vh] justify-center ">
        <div className="flex items-center justify-center flex-col-reverse md:flex-row shadow-lg bg-sky-100 rounded-md md:w-[90%] w-[92vw]">
          <div className="mx-5">
            <div className="py-5 text-md font-serif font-medium px-4  md:h-[650px] flex justify-center text-center md:mt-10 mb-10 md:text-left  items-center ">
              <div className=" tracking-wide">
                ...
                covering a wide range of subjects. <br /> In addition, our
                ...
                <br /> Moreover, we have Memoranda of Understanding (MoUs)
                ...
                remains shielded and available for the greater good. <br />
