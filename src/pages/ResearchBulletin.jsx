 ...
 * Enhanced for all screen sizes with improved responsive design.
 */
...
const StatCard = ({ label, value, note }) => (
  <div className="rounded-xl border bg-white shadow-sm p-3 sm:p-4 lg:p-5">
    <div className="text-2xl sm:text-3xl font-bold break-words">{value}</div>
    <div className="mt-1 text-gray-700 font-medium text-sm sm:text-base break-words">{label}</div>
    {note && <div className="mt-1 text-xs text-gray-500 break-words">{note}</div>}
  </div>
);

const Pill = ({ children }) => (
  <span className="inline-block rounded-full bg-blue-50 px-2 sm:px-3 py-1 text-xs sm:text-sm font-medium text-blue-700 ring-1 ring-blue-100 break-words">
    {children}
  </span>
);
      ...
      <main className="max-w-7xl mx-auto px-2 sm:px-4 space-y-8 sm:space-y-12 pb-16 sm:pb-24">
        <section className="space-y-4 sm:space-y-6">
          ...
          <div className="grid lg:grid-cols-2 gap-4 sm:gap-6">
            <div className="rounded-xl bg-white shadow p-4 sm:p-6 border">
              <h3 className="text-lg sm:text-xl font-bold text-blue-700">Our Vision</h3>
            ...
            <div className="rounded-xl bg-white shadow p-4 sm:p-6 border">
              <h3 className="text-lg sm:text-xl font-bold text-orange-600">Our Mission</h3>
        ...
        <section className="space-y-4 sm:space-y-6">
          ...
          <div className="rounded-2xl bg-gray-50 border shadow-sm p-4 sm:p-6 lg:p-8">
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-3 sm:gap-4">
              <div>
                <h3 className="text-lg sm:text-xl font-bold">Prof. Goutam Sutradhar</h3>
                <p className="text-gray-600 text-sm sm:text-base">Director, NIT Jamshedpur</p>
              </div>
            ...
            <div className="mt-4 sm:mt-5 space-y-3 sm:space-y-4 text-gray-800 leading-relaxed text-sm sm:text-base">
              <p>
        ...
        <section className="space-y-4 sm:space-y-6">
          ...
          <div className="grid xl:grid-cols-2 gap-4 sm:gap-6">
            <div className="rounded-xl bg-white border shadow p-4 sm:p-6">
              <ul className="space-y-2 sm:space-y-3 text-gray-800 list-disc list-inside text-sm sm:text-base leading-relaxed">
                <li>
        ...
        <section className="space-y-4 sm:space-y-6">
          ...
          <div className="grid xl:grid-cols-2 gap-4 sm:gap-6">
            {/* Civil */}
            <div className="rounded-xl border p-4 sm:p-6 shadow bg-white">
              <h3 className="font-bold text-base sm:text-lg">Civil Engineering</h3>
            ...
            {/* Mathematics */}
            <div className="rounded-xl border p-4 sm:p-6 shadow bg-white">
              <h3 className="font-bold text-base sm:text-lg">Mathematics</h3>
              <p className="mt-2 text-gray-700 text-sm sm:text-base leading-relaxed">
            ...
            {/* Physics */}
            <div className="rounded-xl border p-4 sm:p-6 shadow bg-white">
              <h3 className="font-bold text-base sm:text-lg">Physics</h3>
              <p className="mt-2 text-gray-700 text-sm sm:text-base leading-relaxed">
            ...
            {/* Chemistry */}
            <div className="rounded-xl border p-4 sm:p-6 shadow bg-white">
              <h3 className="font-bold text-base sm:text-lg">Chemistry</h3>
              <p className="mt-2 text-gray-700 text-sm sm:text-base leading-relaxed">
            ...
            {/* Electrical */}
            <div className="rounded-xl border p-4 sm:p-6 shadow bg-white">
              <h3 className="font-bold text-base sm:text-lg">Electrical Engineering</h3>
              <p className="mt-2 text-gray-700 text-sm sm:text-base leading-relaxed">
            ...
            {/* ECE */}
            <div className="rounded-xl border p-4 sm:p-6 shadow bg-white">
              <h3 className="font-bold text-base sm:text-lg">Electronics & Communication Engineering</h3>
              <p className="mt-2 text-gray-700 text-sm sm:text-base leading-relaxed">
            ...
            {/* CSE */}
            <div className="rounded-xl border p-4 sm:p-6 shadow bg-white">
              <h3 className="font-bold text-base sm:text-lg">Computer Science & Engineering</h3>
              <p className="mt-2 text-gray-700 text-sm sm:text-base leading-relaxed">
            ...
            {/* Mechanical */}
            <div className="rounded-xl border p-4 sm:p-6 shadow bg-white">
              <h3 className="font-bold text-base sm:text-lg">Mechanical Engineering</h3>
              <p className="mt-2 text-gray-700 text-sm sm:text-base leading-relaxed">
            ...
            {/* PIE */}
            <div className="rounded-xl border p-4 sm:p-6 shadow bg-white">
              <h3 className="font-bold text-base sm:text-lg">Production & Industrial Engineering</h3>
              <p className="mt-2 text-gray-700 text-sm sm:text-base leading-relaxed">
            ...
            {/* MME */}
            <div className="rounded-xl border p-4 sm:p-6 shadow bg-white">
              <h3 className="font-bold text-base sm:text-lg">Metallurgical & Materials Engineering</h3>
              <p className="mt-2 text-gray-700 text-sm sm:text-base leading-relaxed">
        ...
        <section className="space-y-4 sm:space-y-6">
          ...
          <div className="rounded-xl bg-white border shadow p-4 sm:p-6">
            <div className="grid lg:grid-cols-2 gap-3 sm:gap-4 text-xs sm:text-sm lg:text-base">
              <div className="space-y-2">
                <div className="flex items-center gap-2 sm:gap-3">
                  ...
                  <span className="w-8 sm:w-10 text-right text-xs sm:text-sm">30</span>
                </div>
                <div className="flex items-center gap-2 sm:gap-3">
                  <Pill>CSE</Pill>
                  <div className="w-full bg-gray-100 rounded h-2">
                    <div className="bg-blue-500 h-2 rounded" style={{width:'68%'}}/>
                  </div>
                  <span className="w-8 sm:w-10 text-right text-xs sm:text-sm">24</span>
                </div>
                <div className="flex items-center gap-2 sm:gap-3">
                  <Pill>ECE</Pill>
                  <div className="w-full bg-gray-100 rounded h-2">
                    <div className="bg-blue-500 h-2 rounded" style={{width:'62%'}}/>
                  </div>
                  <span className="w-8 sm:w-10 text-right text-xs sm:text-sm">22</span>
                </div>
                <div className="flex items-center gap-2 sm:gap-3">
                  <Pill>EE</Pill>
                  <div className="w-full bg-gray-100 rounded h-2">
                  ...
                  <span className="w-8 sm:w-10 text-right text-xs sm:text-sm">21</span>
                </div>
                <div className="flex items-center gap-2 sm:gap-3">
                  <Pill>ME</Pill>
                  <div className="w-full bg-gray-100 rounded h-2">
                    <div className="bg-blue-500 h-2 rounded" style={{width:'93%'}}/>
                  </div>
                  <span className="w-8 sm:w-10 text-right text-xs sm:text-sm">33</span>
                </div>
              </div>
              <div className="space-y-2">
                <div className="flex items-center gap-2 sm:gap-3">
                  <Pill>MME</Pill>
                  <div className="w-full bg-gray-100 rounded h-2">
                    <div className="bg-blue-500 h-2 rounded" style={{width:'45%'}}/>
                  </div>
                  <span className="w-8 sm:w-10 text-right text-xs sm:text-sm">16</span>
                </div>
                <div className="flex items-center gap-2 sm:gap-3">
                  <Pill>PIE</Pill>
                  <div className="w-full bg-gray-100 rounded h-2">
                  ...
                  <span className="w-8 sm:w-10 text-right text-xs sm:text-sm">14</span>
                </div>
                <div className="flex items-center gap-2 sm:gap-3">
                  <Pill>Chemistry</Pill>
                  <div className="w-full bg-gray-100 rounded h-2">
                    <div className="bg-blue-500 h-2 rounded" style={{width:'32%'}}/>
                  </div>
                  <span className="w-8 sm:w-10 text-right text-xs sm:text-sm">11</span>
                </div>
                <div className="flex items-center gap-2 sm:gap-3">
                  <Pill>Mathematics</Pill>
                  <div className="w-full bg-gray-100 rounded h-2">
                    <div className="bg-blue-500 h-2 rounded" style={{width:'35%'}}/>
                  </div>
                  <span className="w-8 sm:w-10 text-right text-xs sm:text-sm">12</span>
                </div>
                <div className="flex items-center gap-2 sm:gap-3">
                  <Pill>Physics</Pill>
                  <div className="w-full bg-gray-100 rounded h-2">
                    <div className="bg-blue-500 h-2 rounded" style={{width:'25%'}}/>
                  </div>
                  <span className="w-8 sm:w-10 text-right text-xs sm:text-sm">8</span>
                </div>
                <div className="flex items-center gap-2 sm:gap-3">
                  <Pill>Humanities</Pill>
                  <div className="w-full bg-gray-100 rounded h-2">
                    <div className="bg-blue-500 h-2 rounded" style={{width:'22%'}}/>
                  </div>
                  <span className="w-8 sm:w-10 text-right text-xs sm:text-sm">7</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="space-y-4 sm:space-y-6">
          ...
          <div className="grid lg:grid-cols-2 gap-4 sm:gap-6">
            <div className="rounded-xl bg-white border shadow p-4 sm:p-6">
              <h3 className="font-semibold text-sm sm:text-base">Scopus Indexed Publications</h3>
            ...
            <div className="rounded-xl bg-white border shadow p-4 sm:p-6">
              <h3 className="font-semibold text-sm sm:text-base">Consultancy Projects</h3>
              <ul className="mt-3 space-y-2 text-gray-700 text-sm sm:text-base">
            ...
            <div className="rounded-xl bg-white border shadow p-4 sm:p-6">
              <h3 className="font-semibold text-sm sm:text-base">Research Projects</h3>
              <ul className="mt-3 space-y-2 text-gray-700 text-sm sm:text-base">
            ...
            <div className="rounded-xl bg-white border shadow p-4 sm:p-6">
              <h3 className="font-semibold text-sm sm:text-base">Ph.D. Awarded (14th Convocation 2024–25)</h3>
              <ul className="mt-3 space-y-2 text-gray-700 text-sm sm:text-base">
                <li>Total Awarded: <b>39</b></li>
              </ul>
            </div>

            <div className="rounded-xl bg-white border shadow p-4 sm:p-6 lg:col-span-2">
              <h3 className="font-semibold text-sm sm:text-base">Organised Events (2024–25)</h3>
        ...
        <section className="space-y-4 sm:space-y-6">
          ...
          <div className="rounded-xl bg-white border shadow p-4 sm:p-6 space-y-4 sm:space-y-6">
            ...
            <ul className="list-disc list-inside space-y-2 text-gray-800 text-sm sm:text-base leading-relaxed">
            ...
            <div>
              ...
              <div className="mt-3 grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-2 sm:gap-3">
        ...
        <section className="space-y-4 sm:space-y-6">
          ...
          <div className="grid xl:grid-cols-2 gap-4 sm:gap-6">
            ...
            <div className="rounded-xl bg-white border shadow p-4 sm:p-6">
              <h3 className="font-bold text-sm sm:text-base">International Conference on Recent Advances in Materials Processing and Characterization</h3>
            ...
            <div className="rounded-xl bg-white border shadow p-4 sm:p-6">
              <h3 className="font-bold text-sm sm:text-base">National Workshop on Product Design & Development for Rural and Agricultural Applications</h3>
              <p className="mt-2 text-gray-700 text-sm leading-relaxed">
            ...
            {/* UBA */}
            <div className="rounded-xl bg-white border shadow p-4 sm:p-6">
              <h3 className="font-bold text-sm sm:text-base">Unnat Bharat Abhiyan (UBA)</h3>
              <p className="mt-2 text-gray-700 text-sm leading-relaxed">
            ...
            {/* CBDE */}
            <div className="rounded-xl bg-white border shadow p-4 sm:p-6">
              <h3 className="font-bold text-sm sm:text-base">Capacity Building for Design and Entrepreneurship (CBDE)</h3>
              <p className="mt-2 text-gray-700 text-sm leading-relaxed">
            ...
            {/* BIS Activities */}
            <div className="rounded-xl bg-white border shadow p-4 sm:p-6">
              <h3 className="font-bold text-sm sm:text-base">BIS Activities</h3>
              <ul className="mt-3 list-disc list-inside space-y-1 text-gray-700 text-sm leading-relaxed">
            ...
            <div className="rounded-xl bg-white border shadow p-4 sm:p-6">
              <h3 className="font-bold text-sm sm:text-base">Industry Academia Conclave (IAC)</h3>
              <p className="mt-2 text-gray-700 text-sm leading-relaxed">
              ...
              <div className="mt-3">
                <h4 className="font-semibold text-sm">In association with</h4>
              ...
              <div className="mt-4">
                <h4 className="font-semibold text-sm">IAC 2023 Highlights</h4>
                <ul className="mt-2 list-disc list-inside space-y-1 text-gray-700 text-sm leading-relaxed">
        ...
        <section className="space-y-4 sm:space-y-6">
          ...
          <div className="grid xl:grid-cols-2 gap-4 sm:gap-6">
            <div className="rounded-xl bg-white border shadow p-4 sm:p-6">
              <h3 className="font-semibold text-sm sm:text-base">Effect of Nano-particles in Viscoplastic Complex Fluids</h3>
              <p className="text-xs sm:text-sm text-gray-600">Sponsored: DST-SERB | P.I.: Dr. M. A. Hassan (ME)</p>
              <p className="mt-2 text-gray-700 text-sm leading-relaxed">
            ...
            <div className="rounded-xl bg-white border shadow p-4 sm:p-6">
              <h3 className="font-semibold text-sm sm:text-base">Revitalizing the Sacred Art of Ancient Ironmaking</h3>
              <p className="text-xs sm:text-sm text-gray-600">Sponsored: IKS Division, MoE | P.I.: Dr. Ram Krishna (MME)</p>
              <p className="mt-2 text-gray-700 text-sm leading-relaxed">
            ...
            <div className="rounded-xl bg-white border shadow p-4 sm:p-6">
              <h3 className="font-semibold text-sm sm:text-base">Experimental Investigation & CFD Modeling of Centrifugal Slurry Pump</h3>
              <p className="text-xs sm:text-sm text-gray-600">Sponsored: DST-SERB | P.I.: Prof. Satish Kumar (ME)</p>
              <p className="mt-2 text-gray-700 text-sm leading-relaxed">
        ...
        <section className="space-y-4 sm:space-y-6">
          ...
          <div className="grid xl:grid-cols-2 gap-4 sm:gap-6">
            <div className="rounded-xl bg-white border shadow p-4 sm:p-6">
              <h3 className="font-semibold text-sm sm:text-base">MSME-Supported Entrepreneurship & Skill Development</h3>
              <p className="mt-2 text-gray-700 text-sm leading-relaxed">
            ...
            <div className="rounded-xl bg-white border shadow p-4 sm:p-6">
              <h3 className="font-semibold text-sm sm:text-base">5G Use Case Lab</h3>
              <p className="mt-2 text-gray-700 text-sm leading-relaxed">
        ...
        <section className="space-y-4 sm:space-y-6">
          ...
          <div className="rounded-xl bg-white border shadow p-4 sm:p-6 space-y-3 sm:space-y-4">
            <p className="text-gray-800 text-sm sm:text-base leading-relaxed">
        ...
        <section className="space-y-4 sm:space-y-6">
          ...
          <div className="grid xl:grid-cols-2 gap-4 sm:gap-6">
            <div className="rounded-xl bg-white border shadow p-4 sm:p-6">
              <h3 className="font-semibold text-sm sm:text-base">Research Bulletin — Design Team</h3>
              <ul className="mt-3 list-disc list-inside space-y-1 text-gray-700 text-sm leading-relaxed">
            ...
            <div className="rounded-xl bg-gray-50 border shadow p-4 sm:p-6">
              <h3 className="font-semibold text-sm sm:text-base">Media Coverage & Web Team</h3>
              <p className="mt-2 text-gray-700 text-sm leading-relaxed">
