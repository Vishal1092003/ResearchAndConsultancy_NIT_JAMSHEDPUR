  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <header className="w-full mt-6 mb-8 px-4">
        <div className="bg-gradient-to-r from-blue-600 to-orange-500 text-white rounded-2xl shadow-xl p-8 text-center">
        ...
        <section className="space-y-6">
          ...
          <div className="rounded-xl bg-white border shadow p-6">
            <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4">
              <StatCard label="Dean (R&C)" value="Dr. Ashok K Mandal" />
              <StatCard label="Associate Dean (R&C)" value="Prof. Satish Kumar" />
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="rounded-xl bg-white border shadow p-6">
              <ul className="space-y-3 text-gray-800 list-disc list-inside">
                ...
                <li>
                  Signed <b>45+ MoUs</b> with premier institutions, industries, and government
          ...
          <div className="grid lg:grid-cols-2 gap-6">
            <div className="rounded-xl bg-white border shadow p-6">
              ...
              <ul className="mt-3 list-disc list-inside space-y-1 text-gray-700">
                ...
                <li>Swayam Agarwal — B.Tech, 3rd Sem, Computer Science & Engineering</li>
