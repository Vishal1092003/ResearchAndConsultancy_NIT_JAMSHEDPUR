  ...
  return (<>
    <div className='h-[100vh] w-[100vw]  '>
      ...
      <div className=' z-10 flex bg-yellow-50/50  justify-center items-center flex-col '>
        <div className='w-full h-16 md:flex-wrap bg-blue-50/50  flex gap-5'>

          <HashLink to={'./#directormessage'}>
            <div className='w-96 h-14  ml-48  rounded-lg flex justify-center align-centre gap-5 bg-slate-200 text-2xl border-y-2 hover:shadow-lg transition  duration-200 py-1 px-1   hover: bg-blue-50/50 cursor-pointer'>
              <img className='w-50 h-12 rounded-md  ' src={DirectorSir} alt="Direc photo" />
              Director Message
            </div>
          </HashLink>
