...
import DirectorSir from '../assets/DirectorSir.png'
import DeanSir from '../assets/DeanSir.jpeg'
const Home = () => {
  return (<>
    <Navbar />
    <div className='h-[80vh]  w-[100vw]'>
      ...
      <div
        ...
        <div className='min-h-[70vh]'>
          <div className='flex bg-sky-200 shadow-md p-2 mx-4 rounded-lg  font-medium text-3xl font-serif justify-center items-center'>
            Director Message
          </div>
